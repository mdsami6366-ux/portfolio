...
- [x] Increase fixed-navbar scroll clearance so clicked sections begin visibly below the navbar on desktop, tablet, and mobile.
- [x] Shorten supporting copy and reduce vertical padding so the primary content of each section fits more comfortably within one viewport.
