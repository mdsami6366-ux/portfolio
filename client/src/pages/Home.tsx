  ...
  return (
    <div className="portfolio-page">
      ...
      <main>
        ...
        >
          <div className="hero-copy reveal reveal-one">
            <div className="eyebrow">
              <span className="status-dot" /> {portfolio.eyebrow}
            </div>
            ...
            <div className="role-line" aria-label="Roles">
              {portfolio.roles.map((role, index) => (
                <span key={role} className="role-item">
                  {role}
                  {index < portfolio.roles.length - 1 && (
                    <i aria-hidden="true" />
                  )}
                </span>
              ))}
            ...
            <div className="hero-actions">
              ...
              <button
                ...
                type="button"
                onClick={() => handlePlaceholder("Resume")}
              >
            ...
            <div className="hero-footnote">
              ...
              <span>Building ideas with intent</span>
            </div>
          </div>

          <div
            ref={heroArtRef}
            className="hero-art reveal reveal-three"
          ...
          >
            ...
            <div className="portrait-frame">
              <img
                ...
                alt="Replaceable profile placeholder for MD SAMI"
              />
        ...
        <section
          id="about"
          className="section-shell section-about reveal-section"
          aria-labelledby="about-heading"
        >
          <div className="section-heading-row">
            <div>
              <p className="section-kicker">02 / THE PERSON</p>
          ...
          <div className="about-panel glass-panel">
            <div className="about-copy">
              ...
              >
                Know more about me <ArrowUpRight size={16} />
              </button>
            </div>
        ...
        <section
          id="skills"
          className="section-shell section-skills reveal-section"
          aria-labelledby="skills-heading"
        >
          <div className="section-heading-row">
            <div>
              <p className="section-kicker">03 / THE TOOLKIT</p>
              <h2 id="skills-heading" className="section-title">
                Skills<span>.</span>
              </h2>
            </div>
            <p className="section-index">
              Learning by building, one layer at a time
            </p>
          </div>
          <div className="skills-layout">
            ...
            >
              {(Object.keys(portfolio.skills) as SkillCategory[]).map(
                category => {
                  ...
                  return (
                    <button
                      ...
                      className={`skill-category ${activeSkill === category ? "is-selected" : ""}`}
            ...
            <div className="skills-detail glass-panel">
              <div className="skills-detail-top">
                ...
                <span className="skill-count">
                  {String(currentSkills.length).padStart(2, "0")} areas
                </span>
              </div>
              <div className="skill-detail-heading">
                ...
                <div>
                  <p className="section-kicker">{activeSkill}</p>
                  <h3>Tools I&apos;m exploring</h3>
                </div>
              </div>
              <div className="skill-pills" key={activeSkill}>
                {currentSkills.map((skill, index) => (
                  <span
                    className="skill-pill"
                    style={
                      { "--pill-delay": `${index * 45}ms` } as CSSProperties
                    }
                    key={skill}
                  >
                    <Check size={13} />
              ...
              <p className="skills-note">
                This is a working toolkit, not a claim of mastery. The list
                grows with the projects.
              </p>
            </div>
          </div>
        </section>
        ...
        <section
          id="projects"
          className="section-shell section-projects reveal-section"
            ...
            <div className="project-media">
              {currentProject.image ? (
                <img
                  ...
                  alt={`${currentProject.title} abstract project preview`}
                />
              ) : (
                <div
                  className="coming-soon-visual"
                  aria-label="Project preview coming soon"
                >
                  <span>03</span>
                  <div className="coming-orbit" />
                  <div className="coming-orbit coming-orbit-two" />
                </div>
              )}
              <div className="media-glass-label">
                <span className="status-dot" /> {currentProject.status}
              </div>
              <span className="media-index">{currentProject.number} / 03</span>
            </div>
            <div className="project-copy" key={currentProject.id}>
              <div className="project-meta">
                <span>PROJECT {currentProject.number}</span>
              ...
              <div className="project-links">
                <button
                  ...
                  className="text-link"
                  onClick={() =>
                    handlePlaceholder(`${currentProject.title} live project`)
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    handlePlaceholder(`${currentProject.title} GitHub`)
                  }
                >
          ...
          <div className="carousel-controls">
            <div className="carousel-arrows">
              ...
              <button
                ...
                onClick={() =>
                  setActiveProject(
                    index => (index + 1) % portfolio.projects.length
                  )
                }
              >
                <ArrowRight size={18} />
            ...
            <span className="carousel-hint">Use the arrows to explore</span>
          </div>
        </section>

        <section
          id="journey"
          className="section-shell section-journey reveal-section"
          aria-labelledby="journey-heading"
        >
          <div className="section-heading-row">
            <div>
              <p className="section-kicker">05 / THE LEARNING CURVE</p>
              <h2 id="journey-heading" className="section-title">
                My journey<span>.</span>
              </h2>
            </div>
            <p className="section-index">An education-first timeline</p>
          </div>
          <div className="journey-intro">
            <p>
              Not a career timeline. A record of the layers I&apos;m adding as I
              learn to make better things.
            </p>
          </div>
          <div className="journey-line">
            {portfolio.journey.map((item, index) => (
              <div
                className={`journey-item ${index === portfolio.journey.length - 1 ? "is-current" : ""}`}
                key={item.year}
              >
        ...
        <section
          id="contact"
          className="section-shell section-contact reveal-section"
          aria-labelledby="contact-heading"
        >
          <div className="contact-header">
            <p className="section-kicker">06 / OPEN CHANNEL</p>
            <h2 id="contact-heading" className="section-title">
              Let&apos;s connect<span>.</span>
            </h2>
            <p>
              Have an opportunity, project idea, collaboration or simply want to
              connect?
            </p>
          </div>
          <div className="contact-grid">
            ...
            <aside className="contact-aside">
              <div className="contact-aside-art" aria-hidden="true">
                <div className="contact-glass-shape" />
                <div className="contact-glint" />
              </div>
              <div className="contact-links">
                ...
                >
                  ...
                  <strong>/in/yourusername</strong>
                  <ArrowUpRight size={16} />
                </a>
                <a
                  href={portfolio.contact.leetcode}
                  target="_blank"
                  rel="noreferrer"
                >
                  <span>
      ...
      <footer className="site-footer">
        <div className="footer-mark">
          <img src="/portfolio/profile.jpeg" alt="MD SAMI" />
          <span>MD SAMI</span>
        </div>
        <span>© 2026 / Learning in public, building with intent.</span>
